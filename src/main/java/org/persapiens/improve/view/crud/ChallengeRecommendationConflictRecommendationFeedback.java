...
@SuperBuilder
public class ChallengeRecommendationConflictRecommendationFeedback
		implements Serializable, Comparable<ChallengeRecommendationConflictRecommendationFeedback> {
