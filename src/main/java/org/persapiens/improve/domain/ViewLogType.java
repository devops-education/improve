...
public enum ViewLogType {
	...
	LOGIN("login"), HOME("menu home"), CHALLENGE("menu challenge"), RECOMMENDATION("menu recommendation"),
	SUMMARY("menu summary"), USER("menu user"), LOGOUT("logout"), CHALLENGE_DETAIL("challenge detail"),
